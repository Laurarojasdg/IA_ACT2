...
base_conocimiento = {
    "conectado": {
        ("portal 20 de Julio", "Country Sur"): 10,
        ("Country Sur", "Av 1 de Mayo"): 15,
        ("Av 1 de Mayo", "Ciudad Jardin - UAN"): 20,
        ("Ciudad Jardin - UAN", "Policarpa"): 25,
        ("Policarpa", "San Bernardo"): 35,
        ("San Bernardo", "Bicentenario"): 40,
    }
}
...
ruta = encontrar_mejor_ruta("portal 20 de Julio", "Bicentenario")
